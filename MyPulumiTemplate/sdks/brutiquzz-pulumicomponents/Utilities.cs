...
namespace Brutiquzz.Pulumicomponents
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "git://github.com/Brutiquzz/pulumicomponents";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Brutiquzz.Pulumicomponents.version.txt");
    ...
    internal sealed class PulumicomponentsResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PulumicomponentsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
