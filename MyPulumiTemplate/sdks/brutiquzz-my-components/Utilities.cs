...
namespace Brutiquzz.MyComponents
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "git://github.com/Brutiquzz/pulumiexperiment/MyComponents";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Brutiquzz.MyComponents.version.txt");
    ...
    internal sealed class MyComponentsResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public MyComponentsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
